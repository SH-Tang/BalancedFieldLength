...
{
    [TestFixture]
    public class FloatingNumberValidationRuleTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            // Call
            var rule = new FloatingNumberValidationRule();
        ...
        public void Validate_InvalidValidationValues_ReturnsExpectedValidationResult(object validationObject)
        {
            ...
            // Assert
            Assert.That(result.IsValid, Is.False);
            Assert.That(result.ErrorContent, Is.EqualTo($"{validationObject} could not be parsed as a floating number."));
        }
        ...
        private static IEnumerable<TestCaseData> GetValidValidationValues()
        {
            ...
            yield return new TestCaseData("0.011");
            yield return new TestCaseData("1.1E-05");
            yield return new TestCaseData("1.1E+15");
            yield return new TestCaseData("110");
