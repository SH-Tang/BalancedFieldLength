...
{
    [TestFixture]
    public class TestBalancedFieldLengthCalculationModuleFactoryTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            // Call
            var factory = new TestBalancedFieldLengthCalculationModuleFactory();
        ...
        [Test]
        public void CreateModule_Always_ReturnsExpectedType()
        {
            // Setup
            var factory = new TestBalancedFieldLengthCalculationModuleFactory();
