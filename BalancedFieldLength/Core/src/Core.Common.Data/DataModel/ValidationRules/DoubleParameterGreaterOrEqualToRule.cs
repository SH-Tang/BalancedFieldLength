...
namespace Core.Common.Data.DataModel.ValidationRules
{
    ...
    /// </summary>
    public class DoubleParameterGreaterOrEqualToRule : DoubleParameterRuleBase
    {
        private readonly double lowerLimit;

        /// <inheritdoc/>
        /// <summary>
        /// Creates a new instance of <see cref="DoubleParameterGreaterOrEqualToRule"/>.
        /// </summary>
        /// <param name="lowerLimit">The lower limit value which the <paramref name="value"/>
        /// must be greater or equal to.</param>
        public DoubleParameterGreaterOrEqualToRule(string parameterName, double value, double lowerLimit)
