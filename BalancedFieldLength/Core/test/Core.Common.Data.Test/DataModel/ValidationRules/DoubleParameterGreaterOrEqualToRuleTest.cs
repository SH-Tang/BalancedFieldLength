...
{
    [TestFixture]
    public class DoubleParameterGreaterOrEqualToRuleTest : DoubleParameterRuleBaseTestFixture<DoubleParameterGreaterOrEqualToRule>
    {
        [Test]
        [TestCase(0)]
        ...
        public void Execute_WithValuesSatisfyingLimit_ReturnsValidResult(double offset)
        {
            ...
            var rule = new DoubleParameterGreaterOrEqualToRule(parameterName, lowerLimit + offset, lowerLimit);
        ...
        public void Execute_WithValuesNotSatisfyingLimit_ReturnsInvalidResult(double offset)
        {
            ...
            var rule = new DoubleParameterGreaterOrEqualToRule(parameterName, invalidValue, lowerLimit);
        ...
        protected override DoubleParameterGreaterOrEqualToRule CreateRule(string parameterName, double value)
        {
            var random = new Random(21);
            return new DoubleParameterGreaterOrEqualToRule(parameterName, value, random.NextDouble());
        }
    }
}