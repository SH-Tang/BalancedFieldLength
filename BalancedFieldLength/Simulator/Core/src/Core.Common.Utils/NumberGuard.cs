...
namespace Core.Common.Utils
{
    ...
    public static class NumberGuard
    {
        ...
        public static void ValidateParameterLargerThanZero(this double value, string propertyName)
        {
            if (value <= 0)
            {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="value"/>
        /// is less or equal to 0.</exception>
        public static void ValidateParameterLargerThanZero(this int value, string propertyName)
        {
            if (value <= 0)
            {
                throw new ArgumentOutOfRangeException(propertyName, $"{propertyName} must be larger than 0.");
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="value"/>
        /// is less or equal to 0.</exception>
        public static void ValidateParameterLargerThanZero(this Angle value, string propertyName)
        {
        ...
        public static void ValidateParameterLargerOrEqualToZero(this double value, string propertyName)
        {
            if (value < 0)
            {
        ...
        public static void ValidateValueIsConcreteNumber(this double value, string propertyName)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="value"/>
        /// is <see cref="double.NaN"/>, <see cref="double.PositiveInfinity"/> or <see cref="double.NegativeInfinity"/>.</exception>
        public static void ValidateValueIsConcreteNumber(this Angle value, string propertyName)
        {
